tyrano.plugin.kag.layer = {
    ...
    addLayer: function(layer_name) {
        var system_layer = "",
            layer_obj_fore = $("<div class='layer " + layer_name + "_fore layer_fore'></div>"),
    ...
    forelay: function(layer) {
        ...
        for (key in this.map_layer_back)
            if ("" == layer || layer == key) {
                ...
                this.map_layer_back[key].css("display", "none"); - 1 != key.indexOf("message") && this.map_layer_fore[key].css("opacity", "")
            }
    },
    test: function() {}
};