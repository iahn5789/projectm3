...
[button name="credit" storage="" target="credit" graphic="../image/New_GUI/Gamenote_UI/Credit_Bt_01.png" enterimg="../image/New_GUI/Gamenote_UI/Credit_Bt_02.png" width="374" height="601" x="-1920" y="239"]
...
[button name="back" storage="Gallery.ks" target="back" graphic="../image/New_GUI/CG_UI/UI_Close_Bt_01.png" enterimg="../image/New_GUI/CG_UI/UI_Close_Bt_02.png" width="185" height="88" x="-1920" y="965"]
[anim name="gallery" left=82 time=300 effect=easeInQuad]
[anim name="capture" left=541 time=500 effect=easeInQuad]
[anim name="credit" left=1000 time=700 effect=easeInQuad]
[anim name="bt" left=1459 time=900 effect=easeInQuad]
[anim name="back" left=33 time=300 effect=easeInQuad]
[anim name="gamenote" left=0 time=500 effect=easeInQuad]
[wa]
[_tb_end_tyrano_code]
