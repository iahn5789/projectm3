...
<div id="starcatch_background" style="animation: fadein 1s; width: 1920px; height: 1080px;background-image: url('../projectm3/data/image/New_GUI/Workspace_UI/UI_Workspace_Bgi_04.png');">
...
[tb_eval  exp="f.money+=300"  name="money"  cmd="+="  op="t"  val="800"  val_2="undefined"  ]
[tb_start_tyrano_code]
[iscript]
...
<img class="img" src="data/image/New_GUI/Workspace_UI/UI_Success_Text_04.png"/>
</div>
[endhtml]
...
<div class="failbgi">
<img class="img" src="data/image/New_GUI/Workspace_UI/UI_Fail_Bgi_04.png"/>
</div>
[endhtml]
