...
[button name="story" storage="Test_Wait_01.ks" target="callback" graphic="../image/New_GUI/Test_UI/Button_Story_03.png" ensterimg="../image/New_GUI/Test_UI/Button_Story_02.png" width="233" height="67" x="1668" y="739" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Config_Sellect_Click_01.wav"]
[button name="secret" storage="Test_Wait_01.ks" target="" graphic="../image/New_GUI/Test_UI/Button_Secret_01.png" enterimg="../image/New_GUI/Test_UI/Button_Secret_02.png" width="233" height="67" x="1668" y="820" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Config_Sellect_Click_01.wav"]
...
[button name="msgkang01" storage="Test_Wait_Secret.ks" target="msgkang01" graphic="../image/New_GUI/Test_UI/Button_Msg_Kang_01_01.png" enterimg="../image/New_GUI/Test_UI/Button_Msg_Kang_01_02.png" width="151" height="151" x="748" y="-250" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Common_Branch_Click_01.wav"]
[button name="msgkang02" storage="Test_Wait_Secret.ks" target="msgkang02" graphic="../image/New_GUI/Test_UI/Button_Msg_Kang_02_01.png" enterimg="../image/New_GUI/Test_UI/Button_Msg_Kang_02_02.png" width="151" height="151" x="953" y="-250" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Common_Branch_Click_01.wav"]
[button name="msgkang03" storage="Test_Wait_Secret.ks" target="msgkang03" graphic="../image/New_GUI/Test_UI/Button_Msg_Kang_03_01.png" enterimg="../image/New_GUI/Test_UI/Button_Msg_Kang_03_02.png" width="151" height="151" x="1158" y="-250" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Common_Branch_Click_01.wav"]
