[_tb_system_call storage=system/_Workspace_Game_02.ks]
*restart
...
<div id="starcatch_background" class="starcatch_background" style="animation: fadein 1s; width: 1920px; height: 1080px;background-image: url('../projectm3/data/image/New_GUI/Workspace_UI/UI_Workspace_Bgi_02.png');">
...
<div id="starcatch_item" style="width: 27px; height:69px;position: absolute;margin-top:2px;display: inline-block;box-sizing: border-box;animation: linear infinite alternate;;animation-name: move_left_right;animation-duration: 2.7s; animation-duration: leaner;background-image: url('../projectm3/data/image/New_GUI/Workspace_UI/UI_Bar_01.png');">
</div>
...
[tb_eval  exp="f.money+=400"  name="money"  cmd="+="  op="t"  val="400"  val_2="undefined"  ]
[tb_start_tyrano_code]
[iscript]
