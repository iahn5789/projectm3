...
[playse  volume="130"  time="1000"  buf="5"  storage="Amb/Amb_Crowd_Loop_01.wav"  loop="true"  fadein="true"  ]
...
#&[sf.name]
중요한 사실? 그런 게 있으면 그냥 빨리 말해줬으면[r]되잖아.[p]
[chara_part name="Jeon" body="4" face="2" ]
#전대용
...
#
그렇게 만나 본 적도 없는 동아리 부장의 음식 취향까지[r]들어가며 대용이와 함께 길을 걸어갔다.[p]
[_tb_end_tyrano_code]
