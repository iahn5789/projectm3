...
#
[t1]그 뒤로 어딘가 잔뜩 불만이 있는 듯한 표정의 다영이가[r]보였다.[t2][p]
[chara_part name="Kang" body="2" face="2"]
[chara_show name="Kang" time=300 wait=false top="0" left="553" width="813" height="1903"]
...
#
[t1]아무도 없는 학교는 여전히 어색했지만,[t2][p]
#
[t1]누군가가. 그것도 예쁜 여자애가 내 옆에 서 있는 게 더[r]어색했다.[t2][p]
#
[t1]신경을 쓰지 않으려 해도 그럴 때마다 더욱 신경이 쓰였다.[t2][p]
#
[t1]나도 모르게 자꾸만 발을 맞추며 걷고 있었다.[t2][p]
#
[t1]우리 둘 밖에 없는 조용한 복도.[t2][p]
#
[t1]그 복도에 발걸음 소리가 조금씩 울려 퍼지고 있었다.[t2][p]
[_tb_end_tyrano_code]
