...
[ptext layer=2 name="slove" page=fore text="&[f.slove]" size=20 x=-204 y=493 width=150 edge="0xFFEEB0" color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" zindex="5" ]
[ptext layer=2 name="Day" page=fore text="&[f.Day]" size=22 x=-185 y=145 width=50 edge="0xFFEEB0" color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" zindex="5" ]
;[ptext layer=2 name="score" page=fore text="&[f.score]" size=22 x=-199 y=191 width=120 edge="0xFFEEB0" color="0x9B7900" align="right" vertical=false face="NanumGothicRegular" zindex="5" ]
[anim name="money" left=199 time=500 effect=easeInQuad]
[anim name="klove" left=181 time=500 effect=easeInQuad]
[anim name="jlove" left=181 time=500 effect=easeInQuad]
[anim name="slove" left=181 time=500 effect=easeInQuad]
...
[anim name="profilekang" left=305 time=500 effect=easeInQuad]
