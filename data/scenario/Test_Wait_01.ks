...
[ptext layer=2 name="money" page=fore text="&[f.money]" size=22 x=-201 y=236 width=120 color="0x9B7900" align="right" vertical=false face="NanumGothicRegular" ]
[ptext layer=2 name="klove" page=fore text="&[f.klove]" size=20 x=-204 y=403 width=150 color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" ]
[ptext layer=2 name="jlove" page=fore text="&[f.jlove]" size=20 x=-204 y=449 width=150 color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" ]
[ptext layer=2 name="slove" page=fore text="&[f.slove]" size=20 x=-204 y=493 width=150 color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" ]
[ptext layer=2 name="Day" page=fore text="&[f.Day]" size=22 x=-185 y=145 width=50 color="0x9B7900" align="center" vertical=false face="NanumGothicRegular" ]
[ptext layer=2 name="score" page=fore text="&[f.score]" size=22 x=-199 y=191 width=70 color="0x9B7900" align="right" vertical=false face="NanumGothicRegular" ]
...
[button name="story" storage="Test_Wait_01.ks" target="story" graphic="../image/New_GUI/Test_UI/Button_Story_01.png" enterimg="../image/New_GUI/Test_UI/Button_Story_02.png" width="233" height="67" x="2420" y="820" enterse="UI/Common_Click_Hover_01.wav" clickse="UI/Shop_Door_Click__01.wav"]
