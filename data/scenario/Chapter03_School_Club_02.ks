...
[playse  volume="80"  time="1000"  buf="1"  storage="Amb/Amb_Cold_Wind_01.wav"  fadein="true"  loop="false"  ]
[tb_start_tyrano_code]
...
[t1]
#설나희
둘이 싸우지 말고 이 일을 해결할 수 있는 사람이 있잖아[t2][p]
[t1]넌 어떻게 생각해?[t2][p]
[t1]
#&[sf.name]
네...? 저요...?[t2][p]
[t1]
#설나희
둘이 싸우는 거 다 듣고 있었잖아[t2][p]
[t1]너는 어떻게 생각하냐고[t2][p]
[t1]
#&[sf.name]
갑자기 그렇게 물어보시면...[t2][p]
...
[t1]
#&[sf.name]
그래도 밴드에 기타가 없으면 조금 허전하지 아마...[t2][p]
[chara_hide_all time=200 wait=false]
[_tb_end_tyrano_code]
...
[t1]
#강여진
하하! 거봐 그럴 줄 알았어![r]다들 기타를 좋아할 수밖에 없다니까?[t2][p]
[t1]
#진다영
뭐?! 인정할 수 없어! 네가 데려온 사람이잖아![r]그러면 당연히 네 편을 들 수밖에 없는 거 아니야?[t2][p]
[chara_part name="Kang" body="3" face="2" ]
[t1]
#강여진
그래도 역시 밴드에는 기타가 있어야 하지![r]다영이 넌 나한테 진 게 그렇게 분한 거야? 하하하!![t2][p]
[t1]
#진다영
시끄러!! 바보!! 멍청이!! 말미잘!![t2][p]
...
[t1]
#&[sf.name]
그래도 역시 밴드에 베이스가 빠지면 뭔가 허전하지...[t2][p]
...
[t1]
#진다영
하하하하하하하하하핳!! 들었어?[r]이 변태가 방금 베이스가 없으면 허전하다고 했지?[t2][p]
[t1]
#&[sf.name]
그러니까 그 변태는...좀 빼줬으면 좋겠는데...[t2][p]
[chara_part name="Jin" body="1" face="2" ]
[chara_move name="Jin" time="200" width="1169" height="2735" top="0" left="375" ]
[t1]
#진다영
음흉한 생각만 하는 줄 알았는데 나름대로 생각할 줄[r]아는가 보네! 베이스를 아주 정확하게 알고 있잖아?[t2][p]
[_tb_end_tyrano_code]
...
[t1]
#강여진
그래 뭐 틀린 말은 아니니까 내가 한번 봐줬다![t2][p]
[chara_part name="Kang" body="1" face="5" ]
[t1]
#강여진
두고봐! 다음에 다시 물어볼 때 기타가 없으면[r]안 된다는 걸 알게 될 테니까![t2][p]
[chara_part name="Jin" body="1" face="2" ]
[t1]
#진다영
응 아니야~ 다음에도 똑같아~~~~[t2][p]
...
[t1]
#&[sf.name]
둘 다 그만해...[r]좋아하는 악기는 있지만 뭐가 더 중요하다고는 할 수 없어[t2][p]
[t1]
#&[sf.name]
모두 다 똑같은 밴드의 구성원이야[r]그러니 싸우지 말았으면 해...[t2][p]
[t1]
#설나희
...[t2][p]
[t1]
#강여진
맞아 다 똑같이 중요한데[r]부끄러운 모습을 보여버린 것 같네...[t2][p]
[t1]
#진다영
아니..나는 싸우려고 했던 건 아니였는데...[t2][p]
[chara_part name="Sul" body="4" face="1" ]
[t1]
#설나희
그래서 좋아하는 악기는 뭐야?[t2][p]
[t1]
#&[sf.name]
( 앗...당장 생각나는 악기가 없는데... )[t2][p]
[t1]
#&[sf.name]
( 일단 눈에 들어오는 거로..! )[t2][p]
[t1]
#&[sf.name]
저는...드럼...[r]드럼이 제일 좋아요[t2][p]
[chara_hide_all time=200 wait=false]
[chara_part name="Kang" body="3" face="1" ]
[chara_part name="Jin" body="1" face="2" ]
...
[t1]
#강여진
조용한 걸 좋아할 줄 알았는데[r]드럼을 좋아한다니 의외인걸?[t2][p]
[t1]
#강여진
맞아 매력 있는 악기지[r]나도 가끔은 배워보고 싶다니까?[t2][p]
...
[t1]
#강여진
리듬 오브 레전드! 뭔가 엄청날 것 같잖아![t2][p]
[_tb_end_tyrano_code]

[playse  volume="85"  time="1000"  buf="0"  storage="SFX/Crow_Caw_01.wav"  ]
...
[t1]
#강여진
그래서 모든 맴버들이 다 모이면[r]새로 이름을 정하고 싶었어![t2][p]
[t1]
#강여진
추천 할 만한 이름이 있다면 말하도록![t2][p]
...
[playse  volume="65"  time="1000"  buf="0"  storage="UI/Common_Whistle_01.wav"  ]
[tb_start_tyrano_code]
[chara_part name="Jin" body="2" face="2" ]
[t1]
#진다영
그거 완전 축구팀 이름 같은 건 알고 있지?[t2][p]
[t1]
#강여진
뭐야...다들 태클만 걸고 제대로 된 이름이 없잖아![r]
역시 리듬 오브 레전드가 최고라니까...[t2][p]
[chara_part name="Jin" body="3" face="4" ]
[t1]
#진다영
싫어!!! 그런 이름으로 난 하기 싫어!!![t2][p]
[chara_part name="Sul" body="3" face="1" ]
[t1]
#설나희
나도 다른 이름이 좋다고 생각해...[t2][p]
[chara_hide_all time=200 wait=false]
[chara_part name="Kang" body="1" face="4" ]
[chara_show name="Kang" time="200" width="813" height="1903" top="0" left="553" wait=false]
[t1]
...
#&[sf.name]
나는 따로 생각한 건 없는데[r]
[t1]애초에 밴드를 할 생각도 없었다고...[t2][p]
[chara_part name="Kang" body="2" face="4" ]
[t1]
#강여진
그래도 의견은 내야지~ 이제 같은 밴드부원이라구![t2][p]
[t1]
#진다영
이 바보가 무슨 생각이 있겠어![r]음흉한 상상만 하고 있겠지![t2][p]
[chara_part name="Kang" body="2" face="1" ]
[t1]
#&[sf.name]
그건 아니거든![t2][p]
...
[t1]
#강여진
음...러브 크레센도... 나쁘지 않은데![t2][p]
[chara_part name="Kang" body="2" face="1" ]
[t1]
#강여진
크레센도라면 소리를 조금씩 크게 연주하는거잖아?[t2][p]
[t1]
#강여진
뜻도 좋은 것 같아![t2][p]
[chara_hide_all time=200 wait=false]
...
[t1]
#강여진
하하하! 스파이럴 캣츠도 좋은 것 같아![t2][p]
[chara_part name="Kang" body="2" face="1" ]
[t1]
#강여진
아니면 싸우지말고 그냥 리듬 오브 레전드로 하자![t2][p]
[_tb_end_tyrano_code]
