...
tf.cg_posx = [188, 496, 804]; // サムネイルのX座標
tf.cg_posy = [226, 408]; // サムネイルのY座標
tf.cg_thumbnail_width  = 288; // サムネイルの幅
tf.cg_thumbnail_height = 162; // サムネイルの高さ
...
[macro name="pagination"]
  ...
  [ptext layer="0" name="pagination" text="&tf.page + 1 + '/3'" x="0" y="640" size="18" color="0x333333" width="1280" align="center"]
  [endmacro]
...
; ギャラリーモード終了
[button graphic=append_theme/gallery_close.png enterimg=append_theme/gallery_close2.png target=*backtitle x=20 y=600]
...
; 次ページへ
[button graphic=append_theme/gallery_next.png enterimg=append_theme/gallery_next2.png target=*nextpage x=1162 y=360]
...
; 前のページへ
[button graphic=append_theme/gallery_prev.png enterimg=append_theme/gallery_prev2.png target=*backpage x=70 y=360]
