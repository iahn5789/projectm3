...
public class MinigameGachaManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        line.Add(1, ("어떡하지..? 너무 귀여워!", 0, 0));
        line.Add(2, ("그거 그렇게 하는 거 아닌데...", 0, 3));
        line.Add(3, ("고양이가 세상을 구한다!", 2, 1));
        line.Add(4, ("인간은 한 명만 남겨서 캔따개로... 이거 아니야?", 1, 2));
        line.Add(5, ("너무 급하게 하지 않아도 돼. 실패만 하지마...", 0, 0));
        line.Add(6, ("저 아이가 구해달라고 하고 있어!", 0, 3));
        line.Add(7, ("그냥 부숴버리고 꺼내면... 안 되겠지?", 2, 1));
        line.Add(8, ("하나 사면 안 되냐고? 이 아이는 버리자는 거야?", 1, 2));
        line.Add(9, ("치... 침은 안 흘렸거든...! 진짜야!", 2, 1));
        line.Add(10, ("고양이 이름은 슈뢰딩거로 할 거야! 좀 아닌 것 같아?", 1, 2));
        line.Add(11, ("뽀...뽑히나?", 1, 2));
        line.Add(12, ("나 기대해도 되는 거야?", 2, 1));
        line.Add(13, ("중간에 떨어지진 않겠지?", 0, 0));
        line.Add(14, ("드... 드디어!", 0, 0));
        line.Add(15, ("빨리 받아보고 싶어...", 0, 0));
    }
