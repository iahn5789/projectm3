...
public class TestSceneUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SecretMessageLine.Add("52Kang", ("난 고양이보단 강아지가 좋더라.\n참고해!!", 0,1));
        SecretMessageLine.Add("53Kang", ("요즘 행동이 조금 빠진 거 같기도...\n농담이야!", 1,2));
        SecretMessageLine.Add("61Kang", ("창고에 기타가 좀 많긴 하지.\n그러니까 빨리 옮겨!", 1,1));
        SecretMessageLine.Add("62Kang", ("한갑수 선생님이 날 찾는다고? 튀어!!", 5,2));
        SecretMessageLine.Add("63Kang", ("요즘 일진이 영 별로네. 같이 다니는 사람이 별로라 그런 건가..?\n농담이야!", 6,0));
