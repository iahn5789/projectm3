...
public class TestSceneUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DictWeekText.Add("Sul4", ("4주차 제목","시작된 비밀과외","나희 누나와 프리덤을 함께 하기로 한 나는 부원들 몰래 나희 누나에게 비밀과외를 받고 있다. 그런데... 이거 너무 힘든 거 아니야?", "공연장에서 뜻밖의 만남이 있고 얼마 뒤. 나희 누나와의 어색한 재회에서 나는 생각지도 제안을 듣게 된다."));
        ...
        SecretMessageLine.Add("31Kang", ("교무실에서 불렀다고? 나 못 봤다\n그래!", 7,2));
        SecretMessageLine.Add("32Kang", ("바이올린을 기타처럼 들고 켜면\n안 되냐고? 그걸 농담이라고 하는 거야?", 3,0));
        SecretMessageLine.Add("33Kang", ("기타 말고 다른 악기 조율도 부탁해-!", 1,1));
        SecretMessageLine.Add("41Kang", ("강준영 노래..? 뭐! 어쩌라고!!", 4,0));
        SecretMessageLine.Add("42Kang", ("강여진... 바보..? 죽을래?!", 3,2));
        SecretMessageLine.Add("43Kang", ("화면발 잘 받던데? 동영상에 아주 잘 나왔어!", 1,1));
        SecretMessageLine.Add("51Kang", ("향수 좀 뿌리고 다녀. 냄새나...", 3,0));
        SecretMessageLine.Add("52Kang", ("난 고양이보단 강아지가 좋더라. 참고해!!", 0,1));
        SecretMessageLine.Add("53Kang", ("요즘 행동이 조금 빠진 거 같기도... 농담이야!", 1,2));
        SecretMessageLine.Add("61Kang", ("창고에 기타가 좀 많긴 하지. 그러니까 빨리 옮겨!", 1,1));
        SecretMessageLine.Add("62Kang", ("한갑수 선생님이 날 찾는다고? 튀어!!", 5,2));
        SecretMessageLine.Add("63Kang", ("요즘 일진이 영 별로네. 같이 다니는 사람이 별로라 그런 건가..? 농담이야!", 6,0));
